...
# Quadratic function graph example
x = np.arange(-5.0, 5.0, 0.1)
...
# Exponential function with base c graph example
X = np.arange(-5.0, 5.0, 0.1)
...
# Logarithmic function graph example
X = np.arange(-5.0, 5.0, 0.1)
...
# Sigmoidal/logistic function graph example
X = np.arange(-5.0, 5.0, 0.1)
...
# Practice
# Can you calculate the accuracy of our model?
